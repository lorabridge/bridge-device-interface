export const vars = {
    ...
    sse_addr: process.env.VITE_SSE_ADDR || import.meta.env.VITE_SSE_ADDR || "http://127.0.0.1:8080",
    redis_conn_string: process.env.VITE_REDIS_CONN_STRING || import.meta.env.VITE_REDIS_CONN_STRING || "redis://127.0.0.1:6379",
};
